...
Route::get('online/getPackage/{id}',[\App\Http\Controllers\PackagesController::class,'getPackage']);Route::get('online/packages',[\App\Http\Controllers\PackagesController::class,'getAll']);
