        ...
        <b-row>
            <b-col xl="10" lg="9" md="9" sm="12" cols="12" class="overflow-x:auto order-sm-2 order-md-2 order-2"
                ...
                <b-container class="mt-5">
                    ...
                    <!-- Main table element -->
                    <b-table show-empty small stacked="md" class="mt-3 rtl" :items="sites" :fields="fields" :busy="isBusy"
                        bordered>
                    ...
                    <b-modal id="infoModal" :content-class="{
                    ...
                    }" :title="$t('sites')" @hide="clear">
                        <div class="form-input">
                            <input type="text" autocomplete="off" required name="KuTitle" v-model="site.KuTitle" />
                        ...
                        <div class="form-input">
                            <input type="text" autocomplete="off" required name="EnTitle" v-model="site.EnTitle" />
                        ...
                        <div class="form-input">
                            <input type="text" autocomplete="off" required name="ArTitle" v-model="site.ArTitle" />
                        ...
                        <div class="form-input">
                            <input type="text" autocomplete="off" required name="lat" v-model="site.lat" />
                            <label>{{ $t("lat") }}</label>
                        ...
                        <div class="form-input">
                            <input type="text" autocomplete="off" required name="long" v-model="site.long" />
                            <label>{{ $t("long") }}</label>
...
export default {
    ...
    methods: {
        edit(item, index) {
            ...
            this.site.ArTitle = item.ArTitle;
        ...
        save() {
            ...
            formdata.append("ArTitle", this.site.ArTitle);
